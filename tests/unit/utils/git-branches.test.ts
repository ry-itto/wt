...
describe('GitUtils.listBranches', () => {
  ...
  it('should return empty array when git commands fail', () => {
    mockExecSync.mockImplementation(() => {
      throw new Error('git command failed');
    });

    const branches = GitUtils.listBranches(mockRepoPath);
    expect(branches).toEqual([]);
  });

  it('should list local branches correctly', () => {
  ...
  it('should list remote branches correctly', () => {
    // Mock worktree list (empty)
    mockExecSync
      .mockReturnValueOnce('') // worktree list
  ...
  it('should mark branches as in use when they have worktrees', () => {
  ...
  it('should skip remote branches that have local counterparts', () => {
    mockExecSync
      .mockReturnValueOnce('') // worktree list
      .mockReturnValueOnce('main\nfeature') // local branches
  ...
  it('should sort branches with local branches first', () => {
    mockExecSync
      .mockReturnValueOnce('') // worktree list
